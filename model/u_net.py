...
def get_unet_MDCB(input_shape=(1920, 1280, 3), init_nb=44, lr=0.0002, loss=bce_dice_loss, regularizer=None):
    ...
    dilate1 = Conv2D(init_nb*8, (3, 3), padding='same', kernel_regularizer=regularizer, dilation_rate=1)(down3pool)
    dilate1 = Activation('relu')(dilate1)
    dilate2 = Conv2D(init_nb*8, (3, 3), padding='same', kernel_regularizer=regularizer, dilation_rate=2)(dilate1)
    dilate2 = Activation('relu')(dilate2)
    dilate3 = Conv2D(init_nb*8, (3, 3), padding='same', kernel_regularizer=regularizer, dilation_rate=4)(dilate2)
    dilate3 = Activation('relu')(dilate3)
    dilate4 = Conv2D(init_nb*8, (3, 3), padding='same', kernel_regularizer=regularizer, dilation_rate=8)(dilate3)
    dilate4 = Activation('relu')(dilate4)
    dilate5 = Conv2D(init_nb*8, (3, 3), padding='same', kernel_regularizer=regularizer, dilation_rate=16)(dilate4)
    dilate5 = Activation('relu')(dilate5)
    dilate6 = Conv2D(init_nb*8, (3, 3), padding='same', kernel_regularizer=regularizer, dilation_rate=32)(dilate5)
    ...
    up3 = BatchNormalization(name='batch_normalization_13')(up3)
    up3 = Activation('relu')(up3)
    up3 = concatenate([down3, up3])
    up3 = Conv2D(init_nb*4, (3, 3), padding='same', kernel_regularizer=regularizer)(up3)
    up3 = BatchNormalization(name='batch_normalization_14')(up3)
    up3 = Activation('relu')(up3)
    up3 = Conv2D(init_nb*4, (3, 3), padding='same', kernel_regularizer=regularizer)(up3)
    up3 = BatchNormalization(name='batch_normalization_15')(up3)
    up3 = Activation('relu')(up3)

    up2 = UpSampling2D((2, 2))(up3)
    up2 = Conv2D(init_nb*2, (3, 3), padding='same', kernel_regularizer=regularizer)(up2)
    up2 = BatchNormalization(name='batch_normalization_16')(up2)
    up2 = Activation('relu')(up2)
    up2 = concatenate([down2, up2])
    up2 = Conv2D(init_nb*2, (3, 3), padding='same', kernel_regularizer=regularizer)(up2)
    up2 = BatchNormalization(name='batch_normalization_17')(up2)
    up2 = Activation('relu')(up2)
    up2 = Conv2D(init_nb*2, (3, 3), padding='same', kernel_regularizer=regularizer)(up2)
    up2 = BatchNormalization(name='batch_normalization_18')(up2)
    up2 = Activation('relu')(up2)
    
    up1 = UpSampling2D((2, 2))(up2)
    up1 = Conv2D(init_nb, (3, 3), padding='same', kernel_regularizer=regularizer)(up1)
    up1 = BatchNormalization(name='batch_normalization_19')(up1)
    up1 = Activation('relu')(up1)
    up1 = concatenate([down1, up1])
    up1 = Conv2D(init_nb, (3, 3), padding='same', kernel_regularizer=regularizer)(up1)
    up1 = BatchNormalization(name='batch_normalization_20')(up1)
    up1 = Activation('relu')(up1)
    up1 = Conv2D(init_nb, (3, 3), padding='same', kernel_regularizer=regularizer)(up1)
    up1 = BatchNormalization(name='batch_normalization_21')(up1)
    up1 = Activation('relu')(up1)
