...
def get_vgg16(input_shape=(224,224,3), regularizer=None, activation=relu, num_classes=1, optimizer=SGD()):
    ...
    x6 = Conv2D(512, (1, 1), padding='same', name='block6_conv1')(x6c)
    x6 = activation()(x6)
    x6 = Conv2D(512, (3, 3),  padding='same', name='block6_conv2')(x6)
    x6 = activation()(x6)
    x6 = Conv2D(512, (3, 3),  padding='same', name='block6_conv3')(x6)
    x6 = activation()(x6)
    x6 = Conv2D(512, (3, 3),  padding='same', name='block6_conv4')(x6)
    x6 = activation()(x6)
    x6u = UpSampling2D()(x6)

    # Block 7 --> x4
    x7c = concatenate([x6u, x2p])
    x7 = Conv2D(256, (1, 1),  padding='same', name='block7_conv1')(x7c)
    x7 = activation()(x7)
    x7 = Conv2D(256, (3, 3),  padding='same', name='block7_conv2')(x7)
    x7 = activation()(x7)
    x7 = Conv2D(256, (3, 3),  padding='same', name='block7_conv3')(x7)
    x7 = activation()(x7)
    x7 = Conv2D(256, (3, 3),  padding='same', name='block7_conv4')(x7)
    x7 = activation()(x7)
    x7u = UpSampling2D()(x7)

    # Block 8 --> x2
    x8c = concatenate([x7u, x1p])
    x8 = Conv2D(128, (1, 1),  padding='same', name='block8_conv1')(x8c)
    x8 = activation()(x8)
    x8 = Conv2D(128, (3, 3),  padding='same', name='block8_conv2')(x8)
    x8 = activation()(x8)
    x8 = Conv2D(128, (3, 3),  padding='same', name='block8_conv3')(x8)
    x8 = activation()(x8)
    x8u = UpSampling2D()(x8)

    # Block 9 --> x1
    x9c = concatenate([x8u, img_input])
    x9 = Conv2D(64, (1, 1),  padding='same', name='block9_conv1')(x9c)
    x9 = activation()(x9)
    x9 = Conv2D(64, (3, 3),  padding='same', name='block9_conv2')(x9)
    x9 = activation()(x9)
    x9 = Conv2D(64, (3, 3),  padding='same', name='block9_conv3')(x9)
    x9 = activation()(x9)
