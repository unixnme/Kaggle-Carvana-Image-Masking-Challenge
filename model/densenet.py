...
def dense_net_128(input_shape=(256,256,3), optimizer=SGD(), activation=relu, regularizer=None, num_classes=2):
    ...
    x1 = Conv2D(8, (3, 3), kernel_regularizer=regularizer, padding='same')(inputs)
    x1 = activation()(x1)
    x1 = Conv2D(8, (3, 3), kernel_regularizer=regularizer, padding='same')(x1)
    x1 = activation()(x1)
    x1_pool = AveragePooling2D((2, 2))(x1)

    input2 = AveragePooling2D((2,2))(inputs)
    x2c = concatenate([x1_pool, input2], axis=-1)
    x2 = Conv2D(16, (1, 1), kernel_regularizer=regularizer, padding='same')(x2c)
    x2 = activation()(x2)
    x2 = Conv2D(16, (3, 3), kernel_regularizer=regularizer, padding='same')(x2)
    x2 = activation()(x2)
    x2 = Conv2D(16, (3, 3), kernel_regularizer=regularizer, padding='same')(x2)
    x2 = activation()(x2)
    ...
    x3 = Conv2D(32, (1, 1), kernel_regularizer=regularizer, padding='same')(x3c)
    x3 = activation()(x3)
    x3 = Conv2D(32, (3, 3), kernel_regularizer=regularizer, padding='same')(x3)
    x3 = activation()(x3)
    x3 = Conv2D(32, (3, 3), kernel_regularizer=regularizer, padding='same')(x3)
    x3 = activation()(x3)
    ...
    x4 = Conv2D(64, (1, 1), kernel_regularizer=regularizer, padding='same')(x4c)
    x4 = activation()(x4)
    x4 = Conv2D(64, (3, 3), kernel_regularizer=regularizer, padding='same')(x4)
    x4 = activation()(x4)
    x4 = Conv2D(64, (3, 3), kernel_regularizer=regularizer, padding='same')(x4)
    x4 = activation()(x4)
    ...
    x5 = Conv2D(128, (1, 1), kernel_regularizer=regularizer, padding='same')(x5c)
    x5 = activation()(x5)
    x5 = Conv2D(128, (3, 3), kernel_regularizer=regularizer, padding='same')(x5)
    x5 = activation()(x5)
    x5 = Conv2D(128, (3, 3), kernel_regularizer=regularizer, padding='same')(x5)
    x5 = activation()(x5)
    ...
    x7 = Conv2D(128, (1,1), kernel_regularizer=regularizer, padding='same')(x7)
    x7 = activation()(x7)
    x7 = Conv2D(128, (3, 3), kernel_regularizer=regularizer, padding='same')(x7)
    x7 = activation()(x7)
    x7 = Conv2D(128, (3, 3), kernel_regularizer=regularizer, padding='same')(x7)
    x7 = activation()(x7)
    ...
    x8 = Conv2D(64, (1,1), kernel_regularizer=regularizer, padding='same')(x8)
    x8 = activation()(x8)
    x8 = Conv2D(64, (3, 3), kernel_regularizer=regularizer, padding='same')(x8)
    x8 = activation()(x8)
    x8 = Conv2D(64, (3, 3), kernel_regularizer=regularizer, padding='same')(x8)
    x8 = activation()(x8)
    ...
    x9 = Conv2D(32, (1,1), kernel_regularizer=regularizer, padding='same')(x9)
    x9 = activation()(x9)
    x9 = Conv2D(32, (3, 3), kernel_regularizer=regularizer, padding='same')(x9)
    x9 = activation()(x9)
    x9 = Conv2D(32, (3, 3), kernel_regularizer=regularizer, padding='same')(x9)
    x9 = activation()(x9)
    ...
    x10 = Conv2D(16, (1,1), kernel_regularizer=regularizer, padding='same')(x10)
    x10 = activation()(x10)
    x10 = Conv2D(16, (3, 3), kernel_regularizer=regularizer, padding='same')(x10)
    x10 = activation()(x10)
    x10 = Conv2D(16, (3, 3), kernel_regularizer=regularizer, padding='same')(x10)
    x10 = activation()(x10)
    ...
    x11 = Conv2D(8, (1,1), kernel_regularizer=regularizer, padding='same')(x11)
    x11 = activation()(x11)
    x11 = Conv2D(8, (3, 3), kernel_regularizer=regularizer, padding='same')(x11)
    x11 = activation()(x11)
    x11 = Conv2D(8, (3, 3), kernel_regularizer=regularizer, padding='same')(x11)
    x11 = activation()(x11)
