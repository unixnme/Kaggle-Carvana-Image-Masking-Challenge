...
def get_vgg16(input_shape=(224,224,3), regularizer=None, activation=relu, num_classes=1, optimizer=SGD()):
    ...
    x6 = Conv2D(512, (1, 1), padding='same', name='block6_conv1', kernel_regularizer=regularizer)(x6c)
    x6 = activation()(x6)
    x6 = Conv2D(512, (3, 3),  padding='same', name='block6_conv2', kernel_regularizer=regularizer)(x6)
    x6 = activation()(x6)
    x6 = Conv2D(512, (3, 3),  padding='same', name='block6_conv3', kernel_regularizer=regularizer)(x6)
    x6 = activation()(x6)
    x6 = Conv2D(512, (3, 3),  padding='same', name='block6_conv4', kernel_regularizer=regularizer)(x6)
    x6 = activation()(x6)
    x6u = UpSampling2D()(x6)

    # Block 7 --> x4
    x7c = concatenate([x6u, x2p])
    x7 = Conv2D(256, (1, 1),  padding='same', name='block7_conv1', kernel_regularizer=regularizer)(x7c)
    x7 = activation()(x7)
    x7 = Conv2D(256, (3, 3),  padding='same', name='block7_conv2', kernel_regularizer=regularizer)(x7)
    x7 = activation()(x7)
    x7 = Conv2D(256, (3, 3),  padding='same', name='block7_conv3', kernel_regularizer=regularizer)(x7)
    x7 = activation()(x7)
    x7 = Conv2D(256, (3, 3),  padding='same', name='block7_conv4', kernel_regularizer=regularizer)(x7)
    x7 = activation()(x7)
    x7u = UpSampling2D()(x7)

    # Block 8 --> x2
    x8c = concatenate([x7u, x1p])
    x8 = Conv2D(128, (1, 1),  padding='same', name='block8_conv1', kernel_regularizer=regularizer)(x8c)
    x8 = activation()(x8)
    x8 = Conv2D(128, (3, 3),  padding='same', name='block8_conv2', kernel_regularizer=regularizer)(x8)
    x8 = activation()(x8)
    x8 = Conv2D(128, (3, 3),  padding='same', name='block8_conv3', kernel_regularizer=regularizer)(x8)
    x8 = activation()(x8)
    x8u = UpSampling2D()(x8)

    # Block 9 --> x1
    x9c = concatenate([x8u, img_input])
    x9 = Conv2D(64, (1, 1),  padding='same', name='block9_conv1', kernel_regularizer=regularizer)(x9c)
    x9 = activation()(x9)
    x9 = Conv2D(64, (3, 3),  padding='same', name='block9_conv2', kernel_regularizer=regularizer)(x9)
    x9 = activation()(x9)
    x9 = Conv2D(64, (3, 3),  padding='same', name='block9_conv3', kernel_regularizer=regularizer)(x9)
    x9 = activation()(x9)

    classify = Conv2D(num_classes, (1, 1), activation='sigmoid', name='classify', kernel_regularizer=regularizer)(x9)
...
def get_vgg19(input_shape=(224,224,3), regularizer=None, activation=relu, num_classes=1, optimizer=SGD()):
    img_input = Input(shape=input_shape)
    ...
    x3 = Conv2D(256, (3, 3), activation='relu', padding='same', name='block3_conv2', trainable=False)(x3)
    x3 = Conv2D(256, (3, 3), activation='relu', padding='same', name='block3_conv3', trainable=False)(x3)
    x3 = Conv2D(256, (3, 3), activation='relu', padding='same', name='block3_conv4', trainable=False)(x3)
    x3p = MaxPooling2D((2, 2), strides=(2, 2), name='block3_pool')(x3)
    ...
    x4 = Conv2D(512, (3, 3), activation='relu', padding='same', name='block4_conv2', trainable=False)(x4)
    x4 = Conv2D(512, (3, 3), activation='relu', padding='same', name='block4_conv3', trainable=False)(x4)
    x4 = Conv2D(512, (3, 3), activation='relu', padding='same', name='block4_conv4', trainable=False)(x4)
    x4p = MaxPooling2D((2, 2), strides=(2, 2), name='block4_pool')(x4)
    ...
    x5 = Conv2D(512, (3, 3), activation='relu', padding='same', name='block5_conv2', trainable=False)(x5)
    x5 = Conv2D(512, (3, 3), activation='relu', padding='same', name='block5_conv3', trainable=False)(x5)
    x5 = Conv2D(512, (3, 3), activation='relu', padding='same', name='block5_conv4', trainable=False)(x5)
    x5u = UpSampling2D()(x5)
